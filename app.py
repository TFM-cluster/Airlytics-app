...
cluster_info = {
    ...
    3: {"text": "クラスター3: 通勤・通学や休憩時間…", "img": "cluster_3.png"},
    4: {"text": "クラスター4：圧倒的女性…", "img": "cluster_4.png"},
    5: {"text": "クラスター5：40代前後の男性中心…", "img": "cluster_5.png"},
    6: {"text": "クラスター6：女性若年層、深夜型…", "img": "cluster_6.png"},
    7: {"text": "クラスター7：都内在住の男性中高年層…", "img": "cluster_7.png"}
}
